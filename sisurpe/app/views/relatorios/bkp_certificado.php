...
{            
          ...
          if(!$data['presencas']){
            ...
            */
            ...
            Portador do CPF: ' . $data['usuario']->cpf . ' participou como aluno(a) do curso de ' . strtoupper($data['curso']->nome_curso) . ', realizada em Penha/SC, no período de ' . formatadata($data['curso']->data_inicio) . ' a ' . formatadata($data['curso']->data_termino). ', com carga horária de ' . $data['curso']->carga_horaria . ' Horas.'),0, false);          
