<?php
  class Datauser {
    ...
    public function register($data){ 
			...
			(isset($data['end_numero']) && ($data['end_numero']) <> "") 
				? $this->db->bind(':end_numero',$data['end_numero']) 
				: $this->db->bind(':end_numero', NULL);       
			(isset($data['end_bairro_id']) && ($data['end_bairro_id'])<> "NULL") 
				? $this->db->bind(':end_bairro_id',$data['end_bairro_id']) 
				: $this->db->bind(':end_bairro_id', NULL);   
